...
`,
  ...
  },
  {
    ...
    desc: `clear protective coating applied to your car’s exterior that shields the paint from scratches
​`,
    image: "/gray.avif",
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[95%] mt-15 mx-auto h-55 object-top"
                    onError={(e) => {
